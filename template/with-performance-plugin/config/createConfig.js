...
module.exports = (
  ...
  const mainBabelOptions = {
    ...
    cacheDirectory: true,
    presets: [],
    plugins: [require.resolve ('react-loadable/babel')],
  };

  console.log ('ers', require.resolve ('react-loadable/babel'));
  ...
  let config = {
    // Set webpack mode:
    mode: IS_DEV ? 'development' : 'development', // Set webpack context to the current command's directory
    context: process.cwd (), // Specify target (either 'node' or 'web')
    target: target, // Controversially, decide on sourcemaps.
    devtool: IS_DEV ? 'cheap-module-source-map' : 'source-map', // We need to tell webpack how to resolve both Razzle's node_modules and
    ...
    resolve: {
      ...
      mainFields: IS_WEB ? ['browser', 'module', 'main'] : ['main'],
      extensions: ['.mjs', '.jsx', '.js', '.json'],
      alias: {
        // This is required so symlinks work during development.
        'webpack/hot/poll': require.resolve ('webpack/hot/poll'), // Support React Native Web
    ...
    module: {
      ...
      rules: [
        ...
        {test: /\.mjs$/, include: /node_modules/, type: 'javascript/auto'}, // Transform ES6 with Babel
        {
          test: /\.(js|jsx|mjs)$/,
          include: [paths.appSrc, /nut/],
          use: [
            {
